...
const ArticleCard: FC<ArticleCardProps> = ({ id,title,imgPath }) => {
  return (
    <div className={`transition-all articleCard h-[320px] md:h-[425px] bg-gray-500/50 w-[180px] md:w-[270px] relative ${id%2!==0?' skew-y-[8deg] ' :' -skew-y-[8deg] bottom-12'} hover:skew-x-0 hover:skew-y-0 hover:bottom-0`}>
