...
const NewsSection: FC<NewsSectionProps> = ({  }) => {
  return (
    <section className='w-full min-h-screen relative page-format flex justify-center bg-black'>
        <div className='w-full py-20 width-cap flex flex-col items-center px-10 justify-center gap-40'>
          ...
          <div className='flex w-full gap-y-24 lg:gap-y-10  justify-center lg:justify-between gap-10 lg:flex-nowrap flex-wrap'>
            {articles.map((el, _i) => (
